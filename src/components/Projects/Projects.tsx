...
const PROJECTS = [
  {
    ...
    description: "A emergency communication web application that rapidly coordinates nearby volunteers with medical training to provide faster emergency care during critical response windows. Built in Hackathon in a team of 2 under 36 hours. My app matches responder location to patient needs and includes multilingual speech translation features, navigation, hospital selection based on insurance, as well as instructions for initial care - aiming to greatly improve survival rates.",
  ...
  },
  {
    ...
    description:"I built a web application to collect survey feedback from GMU students, keep track of users that submit the survey and list them in tabular format in the UI, maintain records in the database, and perform CRUD operations backend by AWS RDS, Docker, Kubernetes, and Jenkins.",
