...
const enum ESocials {
  LINKEDIN_URL = "https://www.linkedin.com/in/a-verma26",
  GITHUB_URL = "http://github.com/a-verma26",
  INSTAGRAM_URL = "https://www.instagram.com/abhi.verma26/",
  TWITTER_URL = "https://twitter.com/avermacs",
}
